...
<body bgcolor="#0066CC">
	<h3 style="text-transform:capitalize; text-indent:50px;">
		...
		&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?=site_url();?>user_controller/logout" onclick="location.replace(this.href); return false;">Logout</a>
    </h3>
...
<button ><a id="menu" class='inline5' href="#inline_content5">Employer</a></button>
</div>
...
<?php } ?>
<div>	
<?php $this->load->view("pending_reoprt"); ?>
</div>

 <div id="overlay123" style="display:none; text-align: center;" class="overlay123"><img src="<?=site_url()?>assets/images/ajax-load.gif" width="50" height="50" /></div>
</body>
</html>
