...
<?php } ?>
<div>	
<a id="menu" class='inline3' href="#inline_content3" style="margin-left:160px; color:#FFF">Add New Project</a>
<span id="admin_msg" style="margin-left:40px; display:none;">&nbsp;</span>
<table width="461" border="0" id="task_report_admin" cellspacing="5px" cellpadding="5px">
  <caption style="font-size:20px; color:#75FFFF;">
   Project List
  </caption>
  <tr>
  	<th width="92" height="47" scope="col">S No.</th>
    <th width="132" height="47" scope="col">Project Name</th>
    <th width="187" scope="col">Action</th>
  </tr>
  <?php 
  $i=1;
  ...
  <tr>
	...
	<td><a href='<?=site_url()."user_controller/delete/project/".$row["id"];?>' onclick="return confirm('Are you sure\nYou want to Delete it');" >Delete</a> </td>
  </tr>
  <?php $i++; } ?>
</table>
