...
<?php } ?>
<div>	
<a id="menu" class='inline5' href="#inline_content5" style="margin-left:160px; color:#FFF">Add Employer</a>
...
<table width="461" border="0" id="task_report_admin" cellspacing="5px" cellpadding="5px">
  ...
  <tr>
    ...
    <th width="132" height="47" scope="col">Employer Name</th>
  ...
  <tr>
	...
	<td>
	<a href='<?=site_url()."user_controller/delete/employer/".$row["id"];?>' onclick="return confirm('Are you sure');" >Delete</a> 
	</td>
  </tr>
  <?php $i++; } ?>
</table>
