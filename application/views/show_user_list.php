...
<?php } ?>
<div>	
<a id="menu" class='inline' href="#inline_content" style="margin-left:152px; color:#FFF;" >Add User</a>
<span id="admin_msg" style="margin-left:160px; display:none;">&nbsp;</span>
<table width="461" border="0" id="task_report_admin" cellspacing="5px" cellpadding="5px">
  ...
  <tr>
    ...
    <th width="132" height="47" scope="col">Users Name</th>
    <th width="187" scope="col">DOB</th>
  </tr>
  <?php 
  $i=1;
